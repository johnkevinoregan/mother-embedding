...
The `P0-8_RationalGaborFeatures` front end, wrapped as a single `featurize(imgs)` call, plus the
...
include(joinpath(@__DIR__, "..", "P0-8_RationalGaborFeatures", "GaborStack.module.jl"))
include(joinpath(@__DIR__, "..", "P0-8_RationalGaborFeatures", "AndLayer.module.jl"))
include(joinpath(@__DIR__, "..", "P0-8_RationalGaborFeatures", "RayHarmonics.module.jl"))
include(joinpath(@__DIR__, "..", "P0-8_RationalGaborFeatures", "Pooling.module.jl"))
include(joinpath(@__DIR__, "..", "P0-8_RationalGaborFeatures", "GaborStackGPU.module.jl"))
...
`featurize` and cannot drift from it. `P0-8_RationalGaborFeatures/Validate_GPU.jl` gates the maps
