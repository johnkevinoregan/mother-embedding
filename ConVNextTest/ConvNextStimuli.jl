...
# `julia --project=.. -t 16 ConvNextStimuli.jl`   (from the ConVNextTest directory)
#
...
# every arm in `SimpleStrokeTests/RESULTS.md`, so the splits, seeds and generator keywords
...
include(joinpath(@__DIR__, "..", "SimpleStrokeTests", "Contours.module.jl"))
using .Contours
