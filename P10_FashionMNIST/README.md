# P10_FashionMNIST — the front end on something that is not a line drawing
...
then open `P10_FashionMNIST/Explore_FashionMNIST.jl`. Sliders choose the garment class and the
