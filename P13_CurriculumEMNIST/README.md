...
../P11_ConVNextTest/.venv/bin/python extract_convnext_emnist.py    # ~3 min, cached
julia --project=.. Curriculum.jl                               # frozen arms, ~2 min
../P11_ConVNextTest/.venv/bin/python train_convnext_scratch.py     # from scratch, ~3.5 h
...
../P11_ConVNextTest/.venv/bin/python fewshot_train.py              # train on 37 of 47 classes
