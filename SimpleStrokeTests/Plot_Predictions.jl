...
# `julia --project=.. -t 14 Plot_Predictions.jl`   (from the SimpleStrokeTests directory)
#
...
# from a curve.
#
# Identical data for all three arms: the 16,000 / 4,000 i.i.d. stimuli in `ConVNextTest/data`,
...
const FEAT  = joinpath(@__DIR__, "..", "ConVNextTest", "features")
