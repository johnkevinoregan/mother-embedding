...
**If you touch the front end, run the validators** in `../P0-8_RationalGaborFeatures/`:
...
plain energy (`P0-8_RationalGaborFeatures/RESULTS.md`), fixed with a relative `κ·E(x)`. The ray
